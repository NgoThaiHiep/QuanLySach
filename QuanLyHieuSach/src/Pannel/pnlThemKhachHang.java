...
import static Pannel.pnlThemKhachHang.readExcel_districts;
import static Pannel.pnlThemKhachHang.readExcel_wardsDistrict;
...
public class pnlThemKhachHang extends javax.swing.JPanel {
	...
	// TODO: handle exception
        ...
        cities = readExcel_City();
          ...
          txtMaKhachHang.setText(khachHang_DAO.generateVerifyCode());
          System.out.println("mã khách hàng"+khachHang_DAO.generateVerifyCode());
    ...
    private void cboQuanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboQuanActionPerformed
        // TODO add your handling code here:
         String t = cboQuan.getSelectedItem()+"";
